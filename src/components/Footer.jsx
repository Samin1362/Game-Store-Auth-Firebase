...
const Footer = () => {
  return (
    <footer className="relative bg-linear-to-t from-[#0a0a0a] via-[#111] to-[#1a1a1a] text-gray-300 px-8 py-12 mt-20 border-t border-gray-800">
      {/* Glow Effect */}
      <div className="absolute inset-0 bg-linear-to-br from-green-500/10 via-cyan-500/10 to-transparent blur-3xl -z-10" />
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col items-start">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-2xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-green-400 tracking-wide">
              GameStore
            </h1>
          </div>
